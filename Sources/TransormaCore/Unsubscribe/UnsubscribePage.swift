    ...
    public init(html: String, baseURL: URL) throws {
        ...
        for form in parsed.elements("form").prefix(10) {
            ...
            for control in controls {
                ...
                // Browser submit overrides change the destination or wire format. We do not emulate them.
                if ["formaction", "formmethod", "formenctype", "form"].contains(where: {
                    parsed.attribute(control, $0) != nil
                }) {
                    unsafe = true
                    continue
                }
