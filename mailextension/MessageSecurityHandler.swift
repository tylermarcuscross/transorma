...
class MessageSecurityHandler: NSObject, MEMessageSecurityHandler {
  ...
  func getEncodingStatus(
    for message: MEMessage, composeContext: MEComposeContext,
  ...
  func encode(
    _ message: MEMessage, composeContext: MEComposeContext,
  ...
  func extensionViewController(signers messageSigners: [MEMessageSigner])
